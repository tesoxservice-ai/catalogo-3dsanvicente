...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col leading-none">
          <span
            ...
            style={{ color: "#F8F8F8", letterSpacing: "0.12em" }}
          >
            3D{" "}
            <span style={{ color: "#38BDF8" }}>San Vicente</span>
          </span>
          <span
        ...
        <a
          ...
          className="flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-lg transition-all duration-200 hover:opacity-90 active:scale-95"
      ...
      {/* ─── HERO ────────────────────────────────────────────────────── */}
      <section
        className="pt-28 pb-10 px-4 text-center relative overflow-hidden"
      ...
      >
        ...
        <p
          ...
          style={{ color: "#666" }}
        >
          Regalos originales&nbsp;·&nbsp;Decoración&nbsp;·&nbsp;Llaveros&nbsp;·&nbsp;Macetas
        </p>
      ...
      <main className="flex-1 w-full max-w-screen-xl mx-auto px-4 pt-8 pb-16">
        ...
        <div className="flex items-center justify-between mb-4 px-0.5">
          <p className="text-xs" style={{ color: "#555" }}>
            <span style={{ color: "#F8F8F8", fontWeight: 600 }}>
              {filtered.length}
            </span>{" "}
        ...
        {/* CTA banner */}
        <div
          className="mt-12 rounded-2xl px-6 py-8 text-center relative overflow-hidden"
          style={{
            background:
        ...
        >
          ...
          >
            ¿Tenés una idea?{" "}
            <span style={{ color: "#38BDF8" }}>La imprimimos</span>
          </h2>
      ...
      <footer
        className="py-8 px-4"
        style={{ borderTop: "1px solid #1A1A1A", backgroundColor: "#080808" }}
      >
        <div className="max-w-screen-xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-center sm:items-start gap-0.5">
            <span
              ...
              style={{ color: "#F8F8F8" }}
            >
              3D <span style={{ color: "#38BDF8" }}>San Vicente</span>
            </span>
            <span className="text-[10px] tracking-widest uppercase" style={{ color: "#444" }}>
              Impresión 3D Profesional
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm transition-colors hover:text-[#E1306C]"
              style={{ color: "#888" }}
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Copyright */}
          <p className="text-[10px] text-center sm:text-right" style={{ color: "#333" }}>
            © 2026 3D San Vicente
          </p>
        </div>
      </footer>
