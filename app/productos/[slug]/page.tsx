      ...
      <main className="flex-1 w-full max-w-2xl mx-auto px-4 pt-6 pb-16 flex flex-col gap-6">
        ...
        >
          ...
          <div className="absolute top-3 left-3 flex gap-2">
            ...
            {product.has3DModel && (
              <span className="text-xs font-black px-2.5 py-1 rounded-full" style={{ backgroundColor: "#2563EB", color: "#FFFFFF" }}>
                3D
              </span>
            )}
          </div>
        ...
        <div className="flex flex-col gap-3 pt-2">
          {product.has3DModel && !show3D && (
            <button
              ...
              style={{ backgroundColor: "transparent", border: "1.5px solid #2563EB", color: "#2563EB" }}
            >
